declare module "@/lib/shared/app-database.js" {
  const db: {
...
declare module "@/lib/shared/app-auth.js" {
  const auth: {
...
declare module "@/lib/shared/app-functions.js" {
  const functions: {
...
declare module "@/lib/shared/app-content.js" {
